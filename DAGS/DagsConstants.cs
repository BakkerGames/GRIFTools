...
public static class DagsConstants
{
    ...
    public const string ENDFOREACHKEY = "@endforeachkey";
    public const string ENDFOREACHLIST = "@endforeachlist";
    ...
    public const string GOLABEL = "@golabel(";
    ...
    public const string MODTO = "@modto(";
